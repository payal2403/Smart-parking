        ...
        <div className="col-lg-8 text-center text-lg-start mb-lg-0">
          <div className="d-flex flex-wrap">
            <div className="border-end border-primary pe-3">
              <a to="#" className="text-muted small">
          ...
          <div className="navbar-nav mx-0 mx-lg-auto">
           <Link to={"/"}   className="nav-item nav-link">
            ...
            <Link to={"/admin/managecategory"} className="nav-item nav-link">
             ...
             {/* <Link to={"/admin/addspace"} className="nav-item nav-link">
              AddSpace
            </Link>
             <Link to={"/admin/managespace"} className="nav-item nav-link">
              ManageSpace
            </Link> */}
            {/* <a to="blog.html" className="nav-item nav-link">
            ...
            {/* <div className="nav-item dropdown">
              ...
              <div className="dropdown-menu">
                <a to="feature.html" className="dropdown-item">
                  Our Features
                </a>
                ...
                <a to="FAQ.html" className="dropdown-item">
                  FAQs
                </a> */}
            ...
            <a to="contact.html" className="nav-item nav-link active">
              Contact
            </a> */}
