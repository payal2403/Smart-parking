...
const Addslots = () => {
  ...
  const handleForm = (e) => {
    ...
    // data.append("maxVehicleCount",maxVehicleCount)
    // data.append("areaUsed",areaUsed)
    
    
      Apiservices.Addslots(data)
      .then((res) => {
                                ...
                                <div className="contact_form-container">
                                    <div>
                                          ...
                                          <table border="0" cellSpacing="0" cellPadding="10" width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                 <label htmlFor="Numberl">maxVehicleCount:</label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                 <label htmlFor="Numberl">Space:</label>
                                                </td>
                                                <td>
                                                   <select className="form-control" value={spaceId}
                                                onChange={(e) => {
