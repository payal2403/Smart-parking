        ...
        <div className="container py-5">
          <div className="row g-5 align-items-center">
            <div className="col-lg-7">
              <span className="badge bg-light text-primary px-3 py-2 rounded-pill mb-3 fw-bold text-uppercase">
              ...
              {/* Quick Search Box */}
              <div className="card border-0 shadow-lg p-3 rounded-4 bg-white text-dark">
